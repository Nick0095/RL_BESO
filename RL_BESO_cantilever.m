%%%% CODE of combining Reinforcement Learning with BESO BY H.B.Sun 2019.05.03 %%%%
function [ITER,C,IOU,C_difference,nsubopt]=RL_RESO_cantilever(nelx,nely,volfrac,er,rmin,sym,emax,w);
%% INITIALIZE
x(1:nely,1:nelx) = 1.; vol=1.; i = 0; change = 1.; penal = 3.;E=1.0;nu=0.3;
...
% OBJECTIVE FUNCTION AND SENSITIVITY ANALYSIS
    ...
    for ely = 1:nely
        for elx = 1:nelx
            ...
            c(i) = c(i) + 0.5*x(ely,elx)^penal*E*Ue'*KE*Ue;
            dc(ely,elx) = 0.5*x(ely,elx)^(penal-1)*E*Ue'*KE*Ue;            
        end
    end
...
% SHOW ALL ACCEPTABLE STRUCTURES
...
% determine OBJ by both V and dc
